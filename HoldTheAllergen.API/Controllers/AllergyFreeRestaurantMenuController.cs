...
{
    public class AllergyFreeRestaurantMenuController : DefaultController
    {
        private readonly IRestaurantRepository _restaurantRepository;
        private readonly IUserRepository _userRepository;

        public AllergyFreeRestaurantMenuController(IRestaurantRepository restaurantRepository,
        ...
        public IList<RestaurantMenuModel> Get(int restaurantId, Guid userId)
        {
            ...
            var model = RestaurantMenuModelMapper.Map(menuItems, user, false, true);
